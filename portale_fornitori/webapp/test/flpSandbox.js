		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#portalefornitoriportalefornitori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"portalefornitoriportalefornitori-display": {
								"semanticObject": "portalefornitoriportalefornitori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=portalefornitori.portalefornitori",
									"url": sap.ui.require.toUrl("portalefornitori/portalefornitori")
								}
							}
						}
					}
